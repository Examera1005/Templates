...
import { useFormValidation, loginValidationRules } from '../hooks/useFormValidation';
import { LoginFormData, AuthFormProps } from '../types/auth';
 ...
 * - Remember me option
 */
export function LoginForm({ onSuccess, onError, redirectTo, className }: AuthFormProps) {
  ...
  return (
    <div className={`${styles.authForm} ${className || ''}`}>
      <div className={styles.authForm__header}>
        <h1 className={styles.authForm__title}>Welcome back</h1>
        <p className={styles.authForm__subtitle}>Sign in to your account</p>
      </div>
      ...
      <form onSubmit={(e) => { e.preventDefault(); handleSubmit(handleFormSubmit); }}>
        ...
        <div className={styles.authForm__group}>
          <div className={styles.authForm__checkbox}>
            ...
            />
            <label htmlFor="rememberMe" className={styles.authForm__checkboxLabel}>
      ...
      <div className={styles.authForm__footer}>
        <p className={styles.authForm__footerText}>
          ...
          <a href="/signup" className={styles.authForm__footerLink}>
            Sign up
          </a>
        </p>
        <p className={styles.authForm__footerText}>
          <a href="/forgot-password" className={styles.authForm__footerLink}>
